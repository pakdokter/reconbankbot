...
def sum_category(txns, category):
    cat = category.lower()
    return round(sum(t.nominal for t in txns if (t.effective_kategori or "").lower() == cat), 2)


def sum_category_multi(txns, categories):
    cats = {c.lower() for c in categories}
    return round(sum(t.nominal for t in txns if (t.effective_kategori or "").lower() in cats), 2)


def sum_category_prefix(txns, prefix):
    p = prefix.lower()
    return round(sum(t.nominal for t in txns if (t.effective_kategori or "").lower().startswith(p)), 2)
...
_DEFAULT_EMPLOYEE_ALIASES = {
    ...
    "ahmad roziyan": "Ahmad Roziyan Hidayat",
    ...
    "ozan": "Ahmad Roziyan Hidayat",
    "pakdok": "Ahmad Roziyan Hidayat",
    "owner": "Ahmad Roziyan Hidayat",
    "lusiana valufi n": "Lusiana Valufi N",
    "lusiana": "Lusiana Valufi N",
    "upi": "Lusiana Valufi N",
    "upiw": "Lusiana Valufi N",
    "alun ayumi fiqha p": "Alun Ayumi Fiqha P",
    "alun": "Alun Ayumi Fiqha P",
    "luna": "Alun Ayumi Fiqha P",
    "baiq sabrina ameli": "Baiq Sabrina Ameli",
    "sabrina": "Baiq Sabrina Ameli",
    "amel": "Baiq Sabrina Ameli",
    "amelia": "Baiq Sabrina Ameli",
    "viona winda octavia": "Viona Winda Octavia",
    "viona": "Viona Winda Octavia",
    "vio": "Viona Winda Octavia",
    "vivi": "Viona Winda Octavia",
    "ivi": "Viona Winda Octavia",
    "ismayanti": "Ismayanti",
    "maya": "Ismayanti",
    ...
    "kurnia": "Kurnia Utami Nur",
    "kur": "Kurnia Utami Nur",
    "puput": "Kurnia Utami Nur",
    "oriegia shativa mulia": "Oriegia Shativa Mulyadi",
    "oriegia shativa mulyadi": "Oriegia Shativa Mulyadi",
    "oriegia shativa mu": "Oriegia Shativa Mulyadi",
    "gia": "Oriegia Shativa Mulyadi",
    "origia": "Oriegia Shativa Mulyadi",
    "naura lutfia": "Naura Lutfia",
    "naura": "Naura Lutfia",
    "ola": "Naura Lutfia",
    "mila septiana": "Mila Septiana",
    "mila": "Mila Septiana",
    "ridiaton rizki": "Ridiaton Rizki",
    "kik": "Ridiaton Rizki",
    "royyan paice sangwenang": "Royyan Paice Sangwenang",
    "royyan": "Royyan Paice Sangwenang",
    "irma aprianti": "Irma Aprianti",
    "irma": "Irma Aprianti",
    "latifatul husna": "Latifatul Husna",
    "eva": "Latifatul Husna",
    "panji anjanis pran": "Panji Anjanis Pran",
    "panji": "Panji Anjanis Pran",
    "pandji": "Panji Anjanis Pran",
}
